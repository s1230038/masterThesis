...
class FXTrade(gym.core.Env):
    ...
    def step(self, action):
        ...
        ma4 = stat.mean(self._hist_list[self.cur_id-const.MA_WIN4:self.cur_id])
        ma5 = stat.mean(self._hist_list[self.cur_id-const.MA_WIN5:self.cur_id])
